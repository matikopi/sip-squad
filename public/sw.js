...
self.addEventListener('push', (e) => {
  ...
  e.waitUntil(self.registration.showNotification(d.title || 'Sip Squad 💧', {
    body: d.body || '',
    icon: '/icon-192.png',
    badge: '/icon-192.png',
    // One notification at a time: a newer nudge replaces the older one.
    tag: 'sip-squad',
    renotify: true,
    data: { url: d.url || '/' },
  }));
